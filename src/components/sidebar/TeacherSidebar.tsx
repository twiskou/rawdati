      ...
      >
        <div
          style={{
            ...
            fontSize: '16px', fontWeight: '700', color: 'white', flexShrink: 0, overflow: 'hidden',
          }}
        >
          {avatar ? (
      ...
      <form action={logoutAction} style={{ marginTop: '16px' }}>
        <button
          ...
          style={{
            ...
            border: 'none', cursor: 'pointer', color: '#ef4444', fontWeight: '500', fontSize: '14px',
          }}
        >
          <LogOut size={18} />
          {tr.logout}
    ...
    <>
      ...
      >
        ...
        <button
          ...
          style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#374151', display: 'flex', padding: '6px' }}
        >
          <Menu size={24} />
        </button>
      </div>
